...
class genAnuencias:
    def __init__(self, root):
        ...
        self.root = root
        root = style.master
        root.title("DocsGen - Anuências - Tecnico de Segurança do Trabalho")
        ...
        ttk.Label(lblframe_anuencias, text="Técnico de Seg. Trabalho: ").grid(row=0, column=0, padx=(0, 50), sticky=tk.W)

        # Variáveis para os Checkbuttons
        self.var_nr10_tec_seg = tk.BooleanVar(value=False)
        self.var_nr10_sep_tec_seg = tk.BooleanVar(value=False)
        self.var_nr12_tec_seg = tk.BooleanVar(value=False)
        self.var_nr33_tec_seg = tk.BooleanVar(value=False)
        self.var_nr35_tec_seg = tk.BooleanVar(value=False)    

        # Checkbox
        self.ckbx_nr10_tec_seg = ttk.Checkbutton(lblframe_anuencias, text="NR10", variable=self.var_nr10_tec_seg)
        self.ckbx_nr10_tec_seg.grid(row=0, column=1, sticky=tk.W, padx=(0, 10))
        self.ckbx_nr10_sep_tec_seg = ttk.Checkbutton(lblframe_anuencias, text="NR10 SEP", variable=self.var_nr10_sep_tec_seg).grid(row=0, column=2, sticky=tk.W, padx=(0, 10))
        self.ckbx_nr12_tec_seg = ttk.Checkbutton(lblframe_anuencias, text="NR12", variable=self.var_nr12_tec_seg).grid(row=0, column=3, sticky=tk.W, padx=(0, 10))
        self.ckbx_nr33_tec_seg = ttk.Checkbutton(lblframe_anuencias, text="NR33", variable=self.var_nr33_tec_seg).grid(row=0, column=4, sticky=tk.W, padx=(0, 10))
        self.ckbx_nr35_tec_seg = ttk.Checkbutton(lblframe_anuencias, text="NR35", variable=self.var_nr35_tec_seg).grid(row=0, column=5, sticky=tk.W, padx=(0, 10))
    ...
    def nr10_tec_seg(self, substituicoes):
        ...
        doc = Document(os.path.join(caminho_base,'tec_seg', 'nr10_tec_seg.docx'))
        ...
        arq_doc_nr10 = os.path.join(caminho_base, 'tec_seg', 'NR10_temp.docx')
        arq_pdf_nr10 = os.path.join(self.dir_pasta_selecionada, f'NR10_{self.entr_apelido.get()}_{data_hoje}_TEC_SEG.pdf')
    ...
    def nr10_sep_tec_seg(self, substituicoes):
        ...
        # Abra o documento existente
        doc = Document(os.path.join(caminho_base,'tec_seg', 'nr10_sep_tec_seg.docx'))
        ...
        arq_doc_nr10_sep = os.path.join(caminho_base,'tec_seg', 'NR10_SEP_temp.docx')
        arq_pdf_nr10_sep = os.path.join(self.dir_pasta_selecionada, f'NR10_SEP_{self.entr_apelido.get()}_{data_hoje}_TEC_SEG.pdf')
    ...
    def nr12_tec_seg(self, substituicoes):
        ...
        # Abra o documento existente
        doc = Document(os.path.join(caminho_base,'tec_seg', 'nr12_tec_seg.docx'))
        ...
        arq_doc_nr12 = os.path.join(caminho_base,'tec_seg', 'NR12_temp.docx')
        arq_pdf_nr12 = os.path.join(self.dir_pasta_selecionada, f'NR12_{self.entr_apelido.get()}_{data_hoje}_TEC_SEG.pdf')
    ...
    def nr33_tec_seg(self, substituicoes):
        ...
        # Abra o documento existente
        doc = Document(os.path.join(caminho_base,'tec_seg', 'nr33_tec_seg.docx'))
        ...
        arq_doc_nr33 = os.path.join(caminho_base,'tec_seg', 'NR33_temp.docx')
        arq_pdf_nr33 = os.path.join(self.dir_pasta_selecionada, f'NR33_{self.entr_apelido.get()}_{data_hoje}_TEC_SEG.pdf')
    ...
    def nr35_tec_seg(self, substituicoes):
        ...
        # Abra o documento existente
        doc = Document(os.path.join(caminho_base,'tec_seg', 'nr35_tec_seg.docx'))
        ...
        arq_doc_nr35 = os.path.join(caminho_base,'tec_seg', 'NR35_temp.docx')
        arq_pdf_nr35 = os.path.join(self.dir_pasta_selecionada, f'NR35_{self.entr_apelido.get()}_{data_hoje}_TEC_SEG.pdf')
